...
if (isset($_POST['reset'])) 
{
  ...
  if (isset($_POST['submit2'])) 
  {
     ...
     if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) 
     {
         ...
         $query2 = "UPDATE login SET nif='$nif'  WHERE username=$login_session";


         if(mysqli_query($_CONNECTION,$query) or mysqli_query($_CONNECTION,$query2)){
          echo" <script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js\"></script>
          <script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js\"></script>
          <div class=\"container\"><div class=\"alert alert-success alert-dismissible\">
            <a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a>
...
$query_11 = "SELECT id_medico,nome_medico,sexo,nif,estado FROM medicos where nif='$nif'";
$result_11 = mysqli_query($_CONNECTION,$query_11) or die('Query falhou: ' . mysqli_error());
    
     echo "<div class=\"container text-light\"><div class=\"row\"><div class=\"col text-primary\">Id</div><div class=\"col-3 text-primary\">Médico</div><div class=\"col text-primary\">Sexo</div><div class=\"col text-primary\">Nif</div><div class=\"col-4 text-primary\"></div></div>";
     while ($linha = mysqli_fetch_array($result_11, MYSQL_ASSOC)) 
     {
      ...
      echo "<div class=\"row py-2\">";
       ...
       $_RESET="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_medico\" value=\"$id_medico\"><input type=\"hidden\" name=\"nif\" value=\"$nif\"><input type=\"hidden\" name=\"reset\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit2();\">Update Perfil</button></form>";
       $_VER="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_medico\" value=\"$id_medico\"><input type=\"hidden\" name=\"nif\" value=\"$nif\"><input type=\"hidden\" name=\"ver\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit();\">Ver</button></form>";
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-4  text-info float-right">
       <img class="rounded-circle" width="120px" height="120px"src="<?php echo $dir.'/'.$row['foto'];?>">
      </div>
    </div>
    <div class="row">
      <div class="col-2 text-white">
    ...
    <div class="row">
      ...
      <div class="col-5  text-info float-right "><?php echo $row['nome_medico'];?></div>
      <div class="col-5  text-info float-right">&nbsp;</div>
    </div>
    <div class="row">
      <div class="col-2 text-white">
    ...
    <h5 class="text-primary text-center">Consultas do Dia</h5>
      ...
      <div class="col-12">
        ...
        $today = date("n-j-Y"); 
         ...
         $query = "SELECT * FROM  consultas  where id_medico='$id_medico' and data_consulta='$today' and estado='S' order by data_consulta desc";
         $result = mysqli_query($_CONNECTION,$query) or die('Query falhou: ' . mysqli_error());

         echo "<div class=\"container text-light\"><div class=\"row\"><div class=\"col text-primary\">Id</div><div class=\"col-3 text-primary\">Paciente</div><div class=\"col text-primary\">Especialidade</div><div class=\"col text-primary\">Data</div><div class=\"col text-primary mx-auto\">Hora</div><div class=\"col-5 text-primary\">&nbsp;</div></div>";
        ...
        echo "<div class=\"row py-2\">";
        echo "<div class=\"col\">$id_consulta</div><div class=\"col-3\">$nome_paciente</div><div class=\"col\">$descricao</div><div class=\"col\">$data_consulta</div><div class=\"col\">$hora_consulta</div>";

        // LINKS COM VARIAVEIS HIDDEN
        $_PRESCRICAO="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"prescricao\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit();\">Pre</button></form>"; 
        $_APAGAR="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"apagar_c\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-danger btn-sm\" onClick=\"submit();\">Des</button></form>";
        $_RESET="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"reset_c\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit2();\">Update</button></form>";
        ...
        $_INTERNAMENTO="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"internamento\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit2();\">Int</button></form>";
        
        echo "<div class=\"col\">$_APAGAR</div><div class=\"col\">$_RESET</div><div class=\"col\">$_VER</div><div class=\"col\">$_PRESCRICAO</div><div class=\"col\">$_INTERNAMENTO</div></div>";
       }
      echo "</div>";
      //LIBERTAR MEMÓRIA
      mysqli_free_result($result);   
      ...
      <div class="col-12">
        ...
        $today = date("n-j-Y"); 
         ...
         echo "<div class=\"container text-light\"><div class=\"row\"><div class=\"col text-primary\">Id</div><div class=\"col-3 text-primary\">Paciente</div><div class=\"col text-primary\">Especialidade</div><div class=\"col-2 text-primary\">Data</div><div class=\"col text-primary\">Hora</div><div class=\"col-4 text-primary\"></div></div>";
        ...
        echo "<div class=\"row py-2\">";
        echo "<div class=\"col\">$id_consulta</div><div class=\"col-3\">$nome_paciente</div><div class=\"col\">$descricao</div><div class=\"col-2\">$data_consulta</div><div class=\"col text-right\">$hora_consulta</div>";
        
        // LINKS COM VARIAVEIS HIDDEN
        $_PRESCRICAO="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_medico\" value=\"$id_medico\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"prescricao\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit();\">Prec</button></form>"; 
        $_APAGAR="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"apagar_c\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-danger btn-sm\" onClick=\"submit();\">Des</button></form>";
        $_RESET="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"reset_c\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit2();\">Update</button></form>";
        $_VER="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"descricao\" value=\"$descricao\"><input type=\"hidden\" name=\"nome_medico\" value=\"$nome_medico\"><input type=\"hidden\" name=\"ver_c\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit2();\">Ver</button></form>";
        $_INTERNAMENTO="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"internamento\" value=\"1\"><input type=\"hidden\" name=\"p\" value=\"$_p1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit2();\">Int</button></form>";
        
        echo "<div class=\"col\">$_APAGAR</div><div class=\"col\">$_RESET</div><div class=\"col-2\">$_VER</div></div>";
      }
      echo "</div>";
      //LIBERTAR MEMÓRIA
      mysqli_free_result($result);   
        ...
        <div class="container form-group rounded mx-auto d-block border border-light">
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <?php
              $_APAGAR="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"apagar_pre\" value=\"1\"><button class=\"btn btn-danger btn-sm\" onClick=\"submit();\">Del</button></form>";
              $_RESET="<form action=\"\" method=\"post\"><input type=\"hidden\" name=\"id_consulta\" value=\"$id_consulta\"><input type=\"hidden\" name=\"nif\" value=\"$nif_p\"><input type=\"hidden\" name=\"reset_pre\" value=\"1\"><button class=\"btn btn-primary btn-sm\" onClick=\"submit2();\">Update</button></form>";
              ?>
